...
public class JWTService {
    private final static String secret = "eI06ReHIodipKZEvDLyxNBrZYCdmbJTq3xQfcYmO1kmPgIC0G6gc6d3dENAfTlBBFI4sSZfy50qxjTyaE8Jt2rdEaVTWjrXcMjAzvIgldgGAafkTP9WcKLXLh4Y8RJWqUGfZsoet1KHaAMvlLQBmfW";
    ...
    public JWToken generateJWT(String userEmail, Long valid){
        ...
        String access_token = com.auth0.jwt.JWT
                .create()
                .withSubject(userEmail).withExpiresAt(new Date(System.currentTimeMillis() + valid))
                .sign(algorithm);
