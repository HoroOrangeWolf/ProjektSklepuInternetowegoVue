...
public class CategoryService {
  ...
  public Category getCategoryById(Long id) {
    ...
    if (byId.isEmpty()) throw new BadRequestException("Category not found!");
  ...
  public List<CategoryDTO> getTreeCategoriesWithoutParent(
    ...
    for (Category category : categories) {
      categoryDTOList.add(category.getCategoryDTOAsTree(maxTreeLevel - 1));
    }

    return categoryDTOList;
  }

  public List<CategoryDTO> getTreeCategoriesWithParent(
    Long parentId,
    Integer maxTreeLevel
  ) {
