...
public class CategoryController {
    ...
    public void addCategory(@RequestBody CategoryRequest categoryRequest){
        if(categoryRequest.getParentCategoryId()!=null){
            Category category = categoryService.getCategoryById(categoryRequest.getParentCategoryId());
        ...
        categoryService.addCategory(
                new Category(categoryRequest.getName())
        );
    }
    ...
    public List<CategoryDTO> getCategories(
        ...
        return categoryService.getTreeCategoriesWithParent(parentCategoryId, treeLevel);
    }
    ...
    public void updateCategory(@PathVariable("id") Long id, @RequestBody CategoryRequest categoryRequest){
        ...
        categoryService.updateCategory(
                new Category(id, categoryRequest.getName())
        );
    }
}
