      ...
      <n-list class="listItem">
          <n-list-item v-for="(data, index) in orders" :key="index">
              <div class="item">
                ...
                <div class="right">
                    <div class="bottom">
                        <div>Kwota dostawy: {{data.totalPrice}} zł</div>
                        <a :href="data.payLink" v-if="data.paymentStatus==='WAITING_FOR_PAYMENT'">
                            <n-button class="btn">
                                <template #default>
                                    Zapłać
                                </template>
                                <template #icon>
                                    <img src="../../assets/paypal-svg.svg" width="30" height="20" alt="" />
                                </template>
                            </n-button>
                        </a>
                    </div>
