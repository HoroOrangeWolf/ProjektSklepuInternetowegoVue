          ...
          <template #arrow="{ prev, next }">
            <div class="custom-arrow">
              <button type="button" class="custom-arrow--left" @click="prev">
                <n-icon color="grey"
                  ><ArrowBack style="transform: scale(2)"
                /></n-icon>
              </button>
              <button type="button" class="custom-arrow--right" @click="next">
                <n-icon color="grey"
                  ><ArrowForward style="transform: scale(2)"
                /></n-icon>
              </button>
            </div>
          </template>
      ...
      <div class="infoPart">
        <div class="mainInfo">
          ...
          <div class="reviewPart">
            <fa class="star clicked" icon="star" />
            <fa class="star clicked" icon="star" />
            <fa class="star" icon="star" />
            <fa class="star" icon="star" />
            <fa class="star" icon="star" />
            <p class="reviewAmount">(2 opinie)</p>
          </div>
        ...
        <div class="detailsPart">
          ...
          <div  class="detailsPart__info scrolling">
            <span class="scrollButton"
              ><fa class="icon" icon="angles-down"
            /></span>
        ...
        <div class="userSelectPart">
          ...
          <div class="userSelectPart__buttons">
            <n-space class="select" vertical>
              <n-select v-model:value="value" :options="options" />
            </n-space>

            <button class="userSelectPart__buttons__add">
              <fa class="icon" icon="cart-shopping" />Dodaj do koszyka
            </button>
          </div>
          <p class="userSelectPart__info">
            Możesz kupić maks. {{ item.count }} szt. na osobę
          </p>
          <hr />
...
import { NSelect, NSpace, NCarousel, NIcon } from "naive-ui";
import { ArrowBack, ArrowForward } from "@vicons/ionicons5";

export default defineComponent({
  setup() {
    const { getCurrentItem } = inject("currentItem");
  ...
  components: { NSpace, NSelect, NCarousel, NIcon, ArrowBack, ArrowForward },
});
</script>
